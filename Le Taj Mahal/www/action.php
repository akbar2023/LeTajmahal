		...
		mysql_connect($server,$user,$pass);
			...
			if(mysql_num_rows($result)==1 || $_POST['client_mail']=='')
			{
			...
			else
			 {
				...
				mysql_db_query($base,"INSERT INTO `base_client` (`id_zone`, `nom_client`, `prenom_client`, `adresse_client`, `digicode_client` , `tel_client`, `email_client`, `pass_client`) VALUES ('".$_POST['zone']."', '".$_POST['client_name']."', '".$_POST['client_prenom']."', '".$_POST['client_adresse']."', '".$_POST['digicode_adresse']."', '".$_POST['client_tel']."', '".$_POST['client_mail']."', '".md5($_POST['client_pass'])."')");
				...
				mysql_close();
					...
					$contact_info .="<tr><td>Bat. / Digi / ...  </td><td>: ".htmlentities($_POST['digicode_adresse'])."</td></tr>";
