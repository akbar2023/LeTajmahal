...
{
	$base_title_page_out=", Le Taj Mahal - Restaurant Indien - Boulogne billancourt 92";
	switch($_GET['page'])
	{
		case 'resto':
		...
		case 'contact':
			...
			break;
		default:
			$title_page_out="Le Taj Mahal - Restaurant Indien - Boulogne billancourt 92";
	}
}
else
{
...
<div id="site_home">
 ...
 <center><img src="images/logo_home_1.png" /></center>
 <br /><br /><br />
...
<h1>Selectionner votre Zone de Livraison</h1><br /><br />
		...
		<div class="div_form_contact">
			<form action="/beta/index.php?page=commande&action=newaccount" method="POST">
	<select name="zone">
